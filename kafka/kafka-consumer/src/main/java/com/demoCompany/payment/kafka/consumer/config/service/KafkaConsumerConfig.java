...
import com.demoCompany.payment.config.data.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V> {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, kafkaConsumerConfigData.getTrustedPackages());
